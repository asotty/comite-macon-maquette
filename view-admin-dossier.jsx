...
const ECHANTILLONS = [
  ...
  { n: 5, nom: 'Saint-Véran',            appellation: 'Saint-Véran',     complement: 'Climat Les Pommards',      mill: 2022, cep: 'Chardonnay', vol: '75cl', deg: '13°',   s: 'warn', type: 'Blanc tranquille', cuve: 'C-12A',lot: 'L-2022-03', qte: 1900, unite: 'BT', denom: 'Domaine de la Chevalière', anomaly: 'Cuve déclarée "C-12A" ≠ document "C-12B"', refProd: 'CHV-2022-005' },
